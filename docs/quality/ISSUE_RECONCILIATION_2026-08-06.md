...
| #110 | Foundation in next stacked PR | Wave 2 | Stable payload, broken-reference code, JSON CLI, and path policy implemented; title-collision, parser-recovery, filesystem, and reload producers remain |
