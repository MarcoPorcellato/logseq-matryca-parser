...
| Existing delivery anchors | #87, #103, #104, #108, and #111 remain open; #106, #113, and #165 are closed | live GitHub issue reads on 2026-08-21; #108 is being reconciled to active after PR #176 |
...
| M9 delivery | merged through [PR #176](https://github.com/MarcoPorcellato/logseq-matryca-parser/pull/176) | Source head `a8558aca305c43bbadb66b884b9def945f8af36c`, squash merge `2a3679e176772bfcc57ed49b2c7c63d9d7c72346`; CodeQL run `32434564524`, Dependency Review run `32434567688`, and Logos Protocol CI run `32434567730` completed successfully |
...
- This is the second private #108 slice. It adds no public API or dependency and
  does not close #108, #87, #103, #104, or #111. This local qualification is
  preserved as a historical receipt separate from the hosted publication.

**Hosted publication and reconciliation**

- The M9 source was published through [PR #176](https://github.com/MarcoPorcellato/logseq-matryca-parser/pull/176): source head `a8558aca305c43bbadb66b884b9def945f8af36c` was squash-merged as `2a3679e176772bfcc57ed49b2c7c63d9d7d72346`. CodeQL run `32434564524`, Dependency Review run `32434567688`, and Logos Protocol CI run `32434567730` all completed successfully.
- Issue [#108](https://github.com/MarcoPorcellato/logseq-matryca-parser/issues/108) was closed externally with reason `completed` at merge time. It is being reconciled to active because the merged artifacts delivered only the second private slice; reducer, semantic enrichment, final equivalence, and benchmark gates remain.
...
|---|---|---|---|
| 2026-08-21 | M9 hosted publication / PR #176 | merged and hosted-validated | Source head `a8558aca305c43bbadb66b884b9def945f8af36c` was squash-merged as `2a3679e176772bfcc57ed49b2c7c63d9d7d72346`; CodeQL `32434564524`, Dependency Review `32434567688`, and Logos Protocol CI `32434567730` completed successfully. PR #174 merged as `8801498a31251dc9b8b6f0e1106835d87e083e16` and PR #175 as `b56c0c6a6f9f2bc4766c07736c6c566da8c77c3e`. Issue #108 was closed externally at merge time but is reconciled to active because reducer, semantic-enrichment, final-equivalence, and benchmark gates remain. |
