...
| Current milestone | M4 in delivery | isolated branch from qualified local M3 commit `3edbefb`; deterministic, test-only work-growth evidence only; no publication claim |
